...
# 学習及び検証用CSVファイル (TRAIN_NG_PATHはなくてもOK)
...
ax1.set_title("Isolation Forest Test Result")
ax1.grid()
ax1.legend()
...
ax3.axis("off")
ax3.set_title("Isolation Forest Evaluation Summary", fontsize=16, pad=20, y=0.85)
